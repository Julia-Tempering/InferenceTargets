const registry = Dict{Symbol, PackageSpec}(
    ...
    :PigeonsExamples            => PackageSpec(url = "https://github.com/Julia-Tempering/PigeonsExamples", rev = "a54b2f2da9dde5658b07bc9e00826d9f9ac900e2"),
    #:OrbitPosteriorDB           => PackageSpec(url = "https://github.com/Julia-Tempering/OrbitPosteriorDB.git", rev = "1f9c989bac7a817296fdd103abf28e7ba11ad275"), # TODO: move back to https://github.com/sefffal/OrbitPosteriorDB once tested and merged!
